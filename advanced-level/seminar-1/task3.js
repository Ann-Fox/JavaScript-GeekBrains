...
const arryOfDataActive = document.querySelectorAll('div');

const array = Array.from(arryOfDataActive);
console.log(array)

const filterArray = array.fill((element) => element.hasAttribute('data-active'))
